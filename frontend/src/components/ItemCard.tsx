...
export const ItemCard: IItemCardComponent & React.FunctionComponent<IItem> =
    ({id, name, description, imageId, availability, historyId}: IItem) => {
            ...
            <>
                <Card variant="outlined" sx={{borderRadius: 2, borderWidth: 2, borderColor: "#a1a1a1"}}>
                    ...
                    <CardActions disableSpacing>
                        <IconButton aria-label="View user history" onClick={() => dialogRef.current?.openDialog()}>
                            <UserHistory/>
                        </IconButton>
                ...
                <ItemHistoryDialog itemHistoryId={historyId} innerRef={dialogRef}/>
            </>
        );
    }